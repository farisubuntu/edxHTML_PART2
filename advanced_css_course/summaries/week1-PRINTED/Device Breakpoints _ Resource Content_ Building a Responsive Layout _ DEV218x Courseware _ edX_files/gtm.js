...
Z.a.awc=["nonGoogleScripts"],function(){var a=!1;(function(a){Z.__awc=a;Z.__awc.g="awc";Z.__awc.h=!0;Z.__awc.b=0})(function(b){if(a)b.vtp_gtmOnSuccess();else{var c=b.vtp_channel||"na",d,e,g;if(b.vtp_group&&0<=b.vtp_group.indexOf(":")){d=b.vtp_group;for(var h=b.vtp_group.split("|"),k=[],l=g=0;l<h.length;l++)if(h[l]){var m=h[l].split(":");if(2==m.length&&m[0]&&m[1]){var p=parseFloat(m[1]);isNaN(p)||(k.push(X(m[0])+":"+p),g+=p)}}e=k.join("|")}else g=b.vtp_orderValue||0,d=(b.vtp_group||"DEFAULT")+":"+
g,e=X(b.vtp_group||"DEFAULT")+":"+X(g);var q=b.vtp_testMode?"1":"0";try{var r=["merchant="+X(b.vtp_merchantId),"ref="+X(b.vtp_orderRef),"amount="+X(g),"parts="+e,"ch="+X(c),"testmode="+q];b.vtp_currency&&r.push("cr="+X(b.vtp_currency));b.vtp_discountCode&&r.push("vc="+X(b.vtp_discountCode));Bh("https://www.awin1.com/sread.img?tt=ns&tv=2&"+r.join("&"))}catch(v){}try{var w={};w.orderRef=b.vtp_orderRef;w.amount=g;b.vtp_currency&&(w.currency=b.vtp_currency);w.parts=d;b.vtp_discountCode&&(w.voucher=b.vtp_discountCode);
w.channel=c;w.test=q;x.AWIN={Tracking:{Sale:w}};T("https://www.dwin1.com/"+b.vtp_merchantId+".js",b.vtp_gtmOnSuccess,b.vtp_gtmOnFailure);a=!0}catch(v){C(b.vtp_gtmOnFailure)}}})}();
Z.a.awj=["nonGoogleScripts"],function(){var a=!1;(function(a){Z.__awj=a;Z.__awj.g="awj";Z.__awj.h=!0;Z.__awj.b=0})(function(b){if(a)b.vtp_gtmOnSuccess();else try{T("https://www.dwin1.com/"+b.vtp_merchantId+".js",b.vtp_gtmOnSuccess,b.vtp_gtmOnFailure),a=!0}catch(c){C(b.vtp_gtmOnFailure)}})}();
